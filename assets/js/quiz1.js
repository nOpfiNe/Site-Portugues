...
const questions = [
  {
    question: "A história de Bom dia, Camarada se passa em qual país africano?",
    answers: [
  ...
  {
    question: "Qual é o nome do protagonista do livro?",
    answers: [
      { text: "Camarada", correct: false },
      { text: "N'dalu", correct: true },
      { text: "Domingos", correct: false },
      { text: "Aléxis", correct: false }
    ]
  },
  {
